              ...
              <CardContent className="flex flex-col items-center justify-center min-h-[300px]">
                {qrImageUrl ? (
                  <div className="flex flex-col items-center gap-4">
                    <div className="border border-border p-4 rounded-lg bg-white dark:bg-gray-800">
                      <Image
            ...
            <CardContent>
              {qrCodes.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <Button variant="outline" onClick={() => (document.querySelector('[data-value="generate"]') as HTMLElement)?.click()}>
                    <Plus className="mr-2 h-4 w-4" />
                    Create QR Code
                  </Button>
                </div>

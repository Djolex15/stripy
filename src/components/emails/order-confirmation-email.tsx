import {
  ...
  export const OrderConfirmationEmailTemplate = ({ order }: OrderConfirmationEmailProps) => {
    const previewText = `Your order #${order.id.substring(0, 8)} has been confirmed`
        ...
        <Body style={main}>
          <Container style={container}>
            <Section style={logoContainer}>
              <Img
                src="https://yourdomain.com/logo.png" // Replace with your actual logo URL
                width="120"
                height="36"
                alt="Your Brand"
              />
            ...
            <Section style={section}>
              ...
              <Text style={text}>Thank you for your order! We've received your purchase and are processing it now.</Text>
              <Text style={text}>
              ...
              <Section style={ctaContainer}>
                <Link style={button} href="https://yourdomain.com/contact">
                  Contact Support
                </Link>
              </Section>
            </Section>
            ...
            <Section style={footer}>
              <Text style={footerText}>© {new Date().getFullYear()} Your Brand. All Rights Reserved.</Text>
              <Text style={footerText}>Your Address, City, Country</Text>
            </Section>
          </Container>
        </Body>
      </Html>
